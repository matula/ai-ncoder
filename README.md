...
Download **[Qwen2.5-Coder-0.5B-Instruct](https://huggingface.co/Qwen/Qwen2.5-Coder-0.5B-Instruct-GGUF)** (Q8_0 GGUF format, ~506 MB) and place it in `models/`

Most general models will work, but I've been using this 'Qwen2.5' version to keep the app size as small as possible, without training my own model.
